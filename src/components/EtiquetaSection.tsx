...
const EtiquetaSection = () => {
  ...
  const content = {
    pt: {
      ...
      conducts: [
        { icon: '清', text: 'Estar de banho tomado, mãos e pés limpos. Higiene é essencial.' },
        { icon: '切', text: 'Unhas dos pés e mãos sempre cortadas para não machucar o companheiro.' },
        { icon: '着', text: 'Mulheres devem usar camiseta branca de gola fechada por baixo do judogi.' },
        { icon: '結', text: 'Cabelos grandes devem estar bem presos para não soltar durante a aula.' },
        { icon: '洗', text: 'Judogi sempre seco e limpo. Deixar em local arejado para não ter odor.' },
        { icon: '外', text: 'Retirar brincos, anéis, pulseiras, correntes ou qualquer material.' },
        { icon: '帯', text: 'Faixa bem amarrada na cintura com nó firme.' },
        { icon: '履', text: 'Calçados organizados e enfileirados, fundo voltado para o dojo.' },
        { icon: '隠', text: 'Cordões da calça devem ficar para dentro, não aparentes.' },
    ...
    en: {
      ...
      conducts: [
        { icon: '清', text: 'Have taken a shower, hands and feet clean. Hygiene is essential.' },
        { icon: '切', text: 'Fingernails and toenails always trimmed to avoid hurting partner.' },
        { icon: '着', text: 'Women must wear a white t-shirt with closed collar under the judogi.' },
        { icon: '結', text: 'Long hair must be tied back well so it doesn\'t come loose.' },
        { icon: '洗', text: 'Judogi always dry and clean. Keep in airy place to avoid odor.' },
        { icon: '外', text: 'Remove earrings, rings, bracelets, necklaces or any material.' },
        { icon: '帯', text: 'Belt tied securely around waist.' },
        { icon: '履', text: 'Shoes organized and lined up, heels facing the dojo.' },
        { icon: '隠', text: 'Pants drawstrings must be inside, not visible.' },
        { icon: '門', text: 'To ENTER: left foot first. To EXIT: right foot first.' },
      ],
      judogiComponents: [
        { icon: '上', name: 'Uwagi', desc: 'Jacket' },
        { icon: '下', name: 'Zubon/Shitabaki', desc: 'Pants' },
        { icon: '帯', name: 'Obi', desc: 'Belt indicating rank' },
        { icon: '襟', name: 'Eri', desc: 'Collar/Lapel' },
        { icon: '袖', name: 'Sode', desc: 'Sleeve' },
        { icon: '口', name: 'Sode-Guchi', desc: 'Sleeve opening' },
      ],
      beltSystem: {
        basicas: [

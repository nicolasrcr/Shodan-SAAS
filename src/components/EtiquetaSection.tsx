  ...
  const content = {
    pt: {
      ...
      conducts: [
        ...
        { icon: '🥋', text: 'Unhas dos pés e mãos sempre cortadas para não machucar o companheiro.' },
        ...
        { icon: '⛩️', text: 'Para ENTRAR: pé esquerdo primeiro. Para SAIR: pé direito primeiro.' },
      ],
      judogiComponents: [
    ...
    en: {
      ...
      conducts: [
        ...
        { icon: '⛩️', text: 'To ENTER: left foot first. To EXIT: right foot first.' },
      ],
      judogiComponents: [
